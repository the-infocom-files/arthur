...
; "file : MISC.ZIL"
; "auth :   $Author:   DEB  $"
; "date :     $Date:   16 May 1989 21:08:32  $"
; "revs : $Revision:   1.124  $"
; "vers : 1.0"
;"---------------------------------------------------------------------------"
; "Miscellaneous"
...
<OBJECT CH-PLAYER
	(LOC RM-CHURCHYARD)
	(DESC "yourself")
	(SYNONYM ME MYSELF I SELF ARTHUR BOY HUMAN PERSON OWL BADGER SALAMANDER TURTLE EEL)
...
<ROUTINE THIS-IS-IT (OBJ)
	 <COND
	  (<EQUAL? .OBJ
		   <> ,ROOMS ,NOT-HERE-OBJECT ,CH-PLAYER ,INTDIR ,GLOBAL-HERE>
	   <RTRUE>)
	  (<AND <DIR-VERB?>
		<==? .OBJ ,PRSO>>
	   <RTRUE>)>
	 <COND
	  (<OR <FSET? .OBJ ,FL-PERSON>
	       <FSET? .OBJ ,FL-ALIVE>>
	   <COND
	    (<FSET? .OBJ ,FL-FEMALE>
	     <FSET ,HER ,FL-TOUCHED>
