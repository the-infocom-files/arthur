...
; "file : CHESTNUT.ZIL"
; "auth :   $Author:   DEB  $"
; "date :     $Date:   16 May 1989 21:05:48  $"
; "revs : $Revision:   1.44  $"
; "vers : 1.0"
;"---------------------------------------------------------------------------"
; "Horse Chestnuts"
...
<ROUTINE RT-RM-CHESTNUT-PATH ("OPT" (CONTEXT <>) "AUX" OBJ)
	<COND
		(<MC-CONTEXT? ,M-F-LOOK ,M-V-LOOK ,M-LOOK>
			...
			<TELL
"You are" standing " on a track next to a stand of horse chestnut trees that
are loaded with conkers. The track continues to the north and the southeast.|"
			>
			<RFALSE>
		)
		(<MC-CONTEXT? ,M-BEG>
