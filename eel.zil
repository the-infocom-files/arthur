...
; "file : EEL.ZIL"
; "auth :   $Author:   DEB  $"
; "date :     $Date:   15 May 1989 21:52:44  $"
; "revs : $Revision:   1.110  $"
; "vers : 1.0"
;"---------------------------------------------------------------------------"
; "Kraken Puzzle"
...
<ROOM RM-SHALLOWS
	...
	(GLOBAL LG-LAKE RM-ISLAND RM-CAUSEWAY RM-FIELD-OF-HONOR)
				...
				(<IN? ,TH-BRACELET ,CH-KRAKEN>
					<COND
						(<AND <MC-PRSI? ,TH-SWORD>
							...
							<RT-KILL-KRAKEN>)>)>)
		(<AND <VERB? TAKE>
				<IN? ,TH-BRACELET ,RM-FIELD-OF-HONOR>
...
The+verb ,WINNER "take" " a small, refreshing sip of water." CR>)
		...
		(<VERB? ENTER WALK-TO>
			<COND
				(<MC-HERE? ,RM-FIELD-OF-HONOR ,RM-SHALLOWS>
					<RT-DO-WALK ,P?SOUTH>)>)
		(<VERB? EXIT>
			<COND
				(<MC-HERE? ,RM-SHALLOWS>
...
dry path that leads south">
							<COND
								(<NOT <MC-HERE? ,RM-FIELD-OF-HONOR>>
									<TELL " from" the ,RM-FIELD-OF-HONOR>)>
							<TELL ".">)>
					<CRLF>)>)>>
...
<ROOM RM-ABOVE-LAKE
	...
	(GLOBAL LG-LAKE RM-ISLAND RM-FIELD-OF-HONOR)
