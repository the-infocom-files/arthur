...
; "file : TOWN.ZIL"
; "auth :   $Author:   DEB  $"
; "date :     $Date:   16 May 1989 21:04:24  $"
; "revs : $Revision:   1.43  $"
; "vers : 1.0"
;"---------------------------------------------------------------------------"
; "Town stuff"
...
<ROOM RM-TOWN-GATE
	...
	(UP PER RT-FLY-UP)
	(GLOBAL LG-TOWN-GATE LG-TOWN LG-WALL RM-MEADOW RM-FORK-IN-ROAD RM-VILLAGE-GREEN LG-VILLAGE-HUTS)
...
<ROOM RM-VILLAGE-GREEN
	...
	(OUT TO RM-TOWN-GATE)
	(UP PER RT-FLY-UP)
	(GLOBAL LG-TOWN-GATE LG-WALL RM-TOWN-SQUARE LG-VILLAGE-HUTS)
...
defenses. The old Roman wall is crumbling into disrepair here, and there is a
...
take you westward to the meadow, or southwestward to the Field of Honor. In
...
<OBJECT LG-VILLAGE-HUTS
   (LOC LOCAL-GLOBALS)
   (DESC "houses")
   (FLAGS FL-PLURAL)
   (SYNONYM THATCH WATTLE HUT HUTS HOUSE HOUSES BUILDING BUILDINGS WINDOW WINDOWS)
   (ADJECTIVE THATCH THATCHED WATTLE)
   (ACTION RT-LG-VILLAGE-HUTS)
>

<ROUTINE RT-LG-VILLAGE-HUTS ("OPT" (CONTEXT <>))
