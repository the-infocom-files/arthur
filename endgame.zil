...
<ROOM RM-FIELD-OF-HONOR
	...
	(GLOBAL
		...
		RM-CAUSEWAY)
	(ACTION RT-RM-FIELD-OF-HONOR)>

<ROUTINE RT-RM-FIELD-OF-HONOR ("OPT" (CONTEXT <>))
	 <COND
	  (<MC-CONTEXT? ,M-F-LOOK ,M-V-LOOK ,M-LOOK>
	   ...
	   <TELL
" the Field of Honor. To the south is a lake with an island in the middle
of it. To the east is a causeway leading to the island. The meadow lies
to the northwest.|">
	   <RFALSE>)
	  (<MC-CONTEXT? ,M-BEG>
	   <COND
	    (<IN? ,CH-LOT ,RM-FIELD-OF-HONOR>
	     <COND
	      (<VERB? WALK>
	       <COND
...
eternal loyalty." CR>
	  ...
	  (<MC-CONTEXT? ,M-END>
	   <COND
	    (<NOT <IN? ,CH-LOT ,RM-FIELD-OF-HONOR>>
	     <RFALSE>)
	    (<AND <VERB? TRANSFORM>
...
<ROUTINE RT-TRIGGER-ENDGAME ()
	...
	<MOVE ,CH-COURTIERS ,RM-FIELD-OF-HONOR>	; "Mob"
...
eyes. \"Enough!\" he cries. \"This stripling has impugned the honor of the
king. He must answer for it on the Field of Honor.\"||He stands up and
...
the Castle, into the town, and south to the Field of Honor. Townspeople
...
;	<CRLF>
;	<RT-GOTO ,RM-FIELD-OF-HONOR T>
	<SETG OHERE ,HERE>
	<MOVE ,CH-PLAYER ,RM-FIELD-OF-HONOR>
	<SETG HERE ,RM-FIELD-OF-HONOR>
...
proclaims, \"Let this be a warning to all who would challenge the honor of
the High King.\"|">
			<RT-END-OF-GAME>)>>
...
once again alone.">)
		(<AND	<MC-HERE? ,RM-FIELD-OF-HONOR ,RM-SHALLOWS ,RM-MID-LAKE>
...
<ROOM RM-ABOVE-FIELD
	...
	(GLOBAL LG-LAKE LG-TOWN RM-FIELD-OF-HONOR RM-MEADOW RM-ISLAND)
...
<ROUTINE RT-RM-ABOVE-FIELD ("OPT" (CONTEXT <>))
	<COND
		(<MC-CONTEXT? ,M-F-LOOK ,M-V-LOOK ,M-LOOK>
			...
			<TELL
"You are hovering over the Field of Honor. Below you to the south is the
