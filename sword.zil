		...
		(<VERB? EXAMINE>
			<COND
				(<IN? ,TH-SWORD ,TH-BOAR>
					...
					<TELL The ,TH-SWORD " is imbedded in" the ,TH-BOAR "." CR>)>)>>
...
<ROUTINE RT-GN-SWORD (TBL FINDER)
	 <COND
	  ...
	  (<INTBL? ,P-IT-OBJECT
		   ...
		   <FIND-RES-COUNT .TBL>>
	   <RETURN ,P-IT-OBJECT>)
	  (<RT-META-IN? ,TH-EXCALIBUR ,HERE>
	   <RETURN ,TH-EXCALIBUR>)
	  (<RT-META-IN? ,TH-SWORD ,HERE>
	   <RETURN ,TH-SWORD>)
	  (<RT-META-IN? ,TH-LOT-SWORD ,HERE>
	   <RETURN ,TH-LOT-SWORD>)>>
...
must first fight with me. I am the defender of the land that lies beyond.\"" CR>)
				(<VERB? GOODBYE>
					<TELL
"\"You do well to run. At least you escape with your life, if not your honor.\"" CR>)
				(<VERB? THANK>
					<TELL
