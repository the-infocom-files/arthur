...
thorny branches of the bush form an impenetrable barrier on all sides.|">
	       <COND (<IN? ,TH-HAWTHORN ,RM-THORNEY-ISLAND>
...
"|On the ground is a thorny sprig that has fallen from the bush.|">)>
	      ...
	      (<MC-CONTEXT? ,M-BEG>
	       <COND (<IN? ,TH-HAWTHORN ,RM-THORNEY-ISLAND>
		      <COND (<MC-PRSO? ,TH-HAWTHORN ,RM-THORNEY-ISLAND ,GLOBAL-HERE>
			     <COND (<TOUCH-VERB?>
				    <COND (<MC-FORM? ,K-FORM-BADGER>
...
"As you brush up against the sprig, the thorn catches on your fur.|">
					   <SETG GL-UPDATE-WINDOW
						 <BOR ,GL-UPDATE-WINDOW
						      ,K-UPD-DESC ,K-UPD-INVT>>
...
"You shouldn't be able to get here as" aform "." CR>)>)>)>)>)
	      ...
	      (.CONTEXT
	       <RFALSE>)
	      (<VERB? EXAMINE>
	       <COND (<NOT <MC-HERE? ,RM-THORNEY-ISLAND>>
		      <COND (<NOUN-USED? ,RM-THORNEY-ISLAND ,W?ISLAND>
