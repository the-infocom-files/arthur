...
; "file : CASTLE.ZIL"
; "auth :   $Author:   DEB  $"
; "date :     $Date:   16 May 1989 21:06:34  $"
; "revs : $Revision:   1.118  $"
; "vers : 1.0"
;"---------------------------------------------------------------------------"
; "Castle Puzzle"
...
into the air.">)>
			<TELL " A dark passage leads down on the north. The fire">
			<COND
				(<NOT <FSET? ,TH-CASTLE-FIRE ,FL-LIGHTED>>
					<TELL "place">)>
			<TELL " is to the west.|">
		...
		(<MC-CONTEXT? ,M-EXIT>
			<COND
				(<AND <EQUAL? ,P-WALK-DIR ,P?NW ,P?OUT>
					...
					<TELL
"Before you can step through the door, the smith grabs you by the arm and
...
<OBJECT TH-BARREL
	...
	(OUT PER RT-LEAVE-BARREL)  ;"PDL -- THIS DOESN'T MAKE SENSE?"
	(CAPACITY 150)
	(ACTION RT-TH-BARREL)>
...
<ROUTINE RT-LEAVE-BARREL ("OPT" (QUIET <>))
   <COND
      (.QUIET
         <RETURN ,RM-CAS-KITCHEN>)
      (<MC-FORM? ,K-FORM-EEL>
...
<ROUTINE RT-GN-TAPESTRY (R T)
	 <COND (<GLOBAL-IN? ,LG-BADGER-TAPESTRY ,HERE>
		,LG-BADGER-TAPESTRY)
	       (ELSE ,LG-OWL-TAPESTRY)>>
