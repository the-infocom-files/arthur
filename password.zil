...
; "file : PASSWORD.ZIL"
; "auth :   $Author:   DEB  $"
; "date :     $Date:   16 May 1989 21:04:06  $"
; "revs : $Revision:   1.114  $"
; "vers : 1.0"
;"---------------------------------------------------------------------------"
; "Password"
...
your head with his pollaxe." CR>
		...
		(<VERB? CALL>
			<COND
				(<NOT <MC-HERE? ,RM-CELL ,RM-BOTTOM-OF-STAIRS ,RM-HALL
							,RM-END-OF-HALL ,RM-SMALL-CHAMBER>>
					<RFALSE>)
...
<ROOM RM-PARADE-AREA
   ...
   (ACTION RT-RM-PARADE-AREA)
	(THINGS
		(OLD STONE) (TOWER TOWERS) RT-PS-STONE-TOWER)>
...
; "	FL-BROKEN	FL-LOCKED"
; "	---------	---------"
; "		0				0		In Field of Honor - fight is raging"
				...
				(<MC-HERE? ,RM-FIELD-OF-HONOR>
					<COND
						(<AND <FSET? ,CH-LOT ,FL-LOCKED>
							...
							<TELL
"The mob, outraged by your lack of chivalrous behavior, kills you.|">
							<RT-END-OF-GAME>)
						(<FSET? ,CH-LOT ,FL-LOCKED>
							<TELL
