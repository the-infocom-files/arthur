...
". The causeway leads south across the lake to an island. The Field of Honor
lies to the west.|">
			<RFALSE>)
		(<MC-CONTEXT? ,M-ENTER>
...
<OBJECT CH-RED-KNIGHT
	...
	(DESC "red knight")
	(FLAGS FL-ALIVE FL-PERSON FL-NO-DESC FL-SEARCH FL-OPEN FL-TRY-TAKE)
