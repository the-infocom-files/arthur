...
; "file : SYNTAX.ZIL"
; "auth :   $Author:   DEB  $"
; "date :     $Date:   16 May 1989 21:04:34  $"
; "rev  : $Revision:   1.115  $"
; "vers : 1.0"
;"---------------------------------------------------------------------------"
; "Syntax"
...
<SYNTAX ATTACK OBJECT (ON-GROUND IN-ROOM) IN OBJECT = V-STAB>
...
<SYNTAX DIG OBJECT IN OBJECT = V-DIG-IN>
...
<SYNTAX HIT OBJECT (ON-GROUND IN-ROOM) IN OBJECT = V-STAB>
...
<SYNTAX THROW OBJECT (HELD HAVE TAKE MANY) OFF OBJECT (ON-GROUND IN-ROOM) = V-THROW-OVER PRE-PUT>
<SYNTAX THROW OBJECT (HELD HAVE TAKE MANY) OUT OBJECT (ON-GROUND IN-ROOM) = V-THROW-OVER PRE-PUT>
...
<SYNTAX WAIT UNTIL OBJECT (EVERYWHERE) = V-WAIT>
...
<SYNTAX WALK BY OBJECT = V-CLIMB-OVER>
<SYNTAX WALK AROUND OBJECT = V-CLIMB-OVER>
...
<SYNTAX WALK ON OBJECT = V-WALK-TO PRE-WALK>
