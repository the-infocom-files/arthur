...
for you.\"" CR
								...
								(T
									...
									<COND
										...
										(T
											<TELL
"\"No? Non? You do not want ze spices?\" He shakes his head. \"I
...
<ROUTINE RT-CH-COOK ("OPT" (CONTEXT <>) "AUX" OBJ)
	<COND
...
"\"Sittin' out there with their noses in their ale. Same as always.\"" CR
		...
		(,NOW-PRSI
            ...
            (<VERB? SHOW GIVE>
               <COND
                  (<MC-PRSO? ,TH-SPICE-BOTTLE ,TH-SPICE ,TH-CUPBOARD-KEY>
                     <COND
                        (<MC-PRSO? ,TH-SPICE>
                     ...
                     >
                     <MOVE .OBJ ,TH-CUPBOARD>
                     <FCLEAR ,TH-CUPBOARD ,FL-OPEN>
                     <FCLEAR ,TH-CUPBOARD ,FL-LOCKED>
                     <TELL
The ,CH-COOK " snatches" the .OBJ " away from you and says, \"'Ow did you get
that?\" He cuffs you on the side of the head"
                     >
                     <COND
                        (<MC-HERE? ,RM-TAV-KITCHEN>
                           <TELL
", replaces" the .OBJ " in the cupboard, and closes the door." CR
                           >
                        )
...
"|The cook leaves the room in response to a shout from a thirsty customer." CR
		...
		(<ZERO? ,GL-COOK-NUM>
			...
			<COND
				(<MC-HERE? ,RM-TAV-KITCHEN>
					<TELL
"|You hear footfalls outside. The cook is returning." CR
					>
				)
			>
		)
...
<OBJECT TH-BIRD
	(LOC TH-CAGE)
	(DESC "bird")
	(FLAGS FL-ALIVE FL-NO-LIST FL-TRY-TAKE)
	(SYNONYM BIRD)
	(SIZE 5)
	(GENERIC RT-GN-BIRD)
	(ACTION RT-TH-BIRD)
...
like pepper." CR
		...
		(<VERB? TAKE>
		 <COND (<IN? ,TH-SPICE-BOTTLE ,WINNER>
			<REMOVE ,TH-SPICE>
			<TELL
...
the ,TH-GROUND "." CR
			>)
		       (T
			<PERFORM ,V?TAKE ,TH-SPICE-BOTTLE>
			<RTRUE>)>
		)
		(<VERB? EXAMINE>
			<TELL
"The spice is light brown in color, and it is very fine-grained." CR
			>
		)
	>
>
