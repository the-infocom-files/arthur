		...
		(<MC-CONTEXT? ,M-BEG>
			<COND
				...
				(<AND <VERB? DISMOUNT>
				 ...
				 <TELL
"You leap off the side of the mountain, and as you fall through the air
towards the sharp rocks below, it occurs to you that you're probably going
to be hearing from Merlin again very soon." CR CR
...
"\"Take my advice, my boy. Never give a sucker an even break.\"" CR>)
		...
		(<AND <VERB? LISTEN>
		 ...
		 <TELL
"It's something about the drunken King of England, but you wouldn't repeat
the words in polite company." CR>)>>
