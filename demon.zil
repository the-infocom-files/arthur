...
; "file : DEMON.ZIL"
; "auth :   $Author:   DEB  $"
; "date :     $Date:   16 May 1989 21:06:52  $"
; "revs : $Revision:   1.78  $"
; "vers : 1.0"
;"---------------------------------------------------------------------------"
; "Hall of Demon"
...
<ROUTINE RT-RM-DEMON-HALL ("OPT" (CONTEXT <>))
	<COND (<MC-CONTEXT? ,M-F-LOOK ,M-V-LOOK ,M-LOOK>
...
that she is sitting on a Golden Fleece.">)
		     (T
		      <TELL "of the hall, a ">
		      <COND (<FSET? ,CH-DEMON ,FL-LOCKED>
			     <TELL "beautiful girl">)
			    (T
			     <TELL "hideous demon">)>
		      <TELL " is sitting on">
		      <COND (<IN? ,TH-FLEECE ,TH-DEMON-THRONE>
		      ...
		      <COND (<FSET? ,CH-DEMON ,FL-LOCKED>
			    ...
			    (T
			     <TELL "His">)>
		      <TELL " ">
		      <COND (<OR <FSET? ,TH-LEFT-MANACLE ,FL-OPEN>
				 <FSET? ,TH-RIGHT-MANACLE ,FL-OPEN>>
			     <COND (<FSET? ,TH-LEFT-MANACLE ,FL-OPEN>
				    <TELL "right ">)
				   (T
				    <TELL "left ">)>
			     <TELL "hand is">)
		      ...
		      <COND (<OR <IN? ,TH-GOLD-KEY ,CH-GIRL>
	      ...
	      (<MC-CONTEXT? ,M-ENTER>
	       ...
	       <COND (<EQUAL? ,GL-WINDOW-TYPE ,K-WIN-PICT>
		      <RT-UPDATE-PICT-WINDOW>)>
	       <RFALSE>)
	      (<MC-CONTEXT? ,M-ENTERED>
	       <COND (<FSET? ,CH-DEMON ,FL-LOCKED>
		      <COND (<FSET? ,CH-GIRL ,FL-LOCKED>
...
to this cruel fate!\"||">)>)>
	       <COND (<FSET? ,LG-HOT-DOOR ,FL-OPEN>
		      <FCLEAR ,LG-HOT-DOOR ,FL-OPEN>
		      <TELL  The ,LG-HOT-DOOR 
			     " swings shut behind you with an ominous \"clank.\"||">)>
	       <RFALSE>)
	      (.CONTEXT
	       <RFALSE>)>>
...
of the contract. If you accept my offer, and then fail to honor the contract
